...
schema_view = get_schema_view(
   openapi.Info(
      ...
      default_version='v1',
      description="API for managing personal finances and viewing analytical dashboards.",
...
roles_router.register(r'available-permissions', PermissionListView, basename='available-permissions')
